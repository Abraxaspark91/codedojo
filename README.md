...
Python 코딩을 연습할 수 있는 AI 기반 학습 도구입니다. LM Studio의 로컬 AI 모델을 활용하여 문제 풀이, 피드백, 오답노트 관리 등의 기능을 제공합니다.
...
**처음 사용하는 경우**: LM Studio를 열고 추천 모델을 다운로드합니다. 그 다음 npm start 실행!

**모델이 이미 있는 경우**: npm start 직후 열리는 화면에서, 원하는 모델을 선택하고 로컬 서버를 시작합니다. 기본 엔드포인트는 `http://127.0.0.1:1234`입니다.

**VRAM/시스템RAM 용량별 추천 모델**
...
**문제 풀이**: 난이도별(Lv0~Lv5), 언어별(SQL, Python, PySpark)로 분류된 문제를 선택하여 풀 수 있습니다.
